...
const config: StorybookConfig = {
  ...
  // Wardnet logo. The package exports these as "@wardnet/brand/svg/*" but on
  // disk they live in assets/dist, which is what staticDirs needs.
  staticDirs: ["../../brand/assets/dist"],
